...
<body class="body">
	<div class="container-fluid maclasse">
			<div class="contenu">
				<div class="row">
					...
					<article class ="col-md-6"> <p class="titre">Articles </p></article>
	...
	<div class="container-fluid image">
			<div class="contenu">
				<div class="row">
					<article class ="col-md-12"> <h1> </h1></article>
				</div>
			</div>
	</div>
...
<div class="container-fluid ">
			<div>
				<div class="row">
					...
					<article class ="col-md-2 new"> <a href="facture.php"> <strong><font color="black">Confirmer</strong></font>  </a></article>
					<article class ="col-md-4"> <h1> </h1></article>
				</div>
			</div>
	</div>
